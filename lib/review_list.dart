  ...
  Widget build(BuildContext context) {
    ...
    final reviewList = Column(
      children:<Widget> [
        ...
        Review("assets/images/persona3.jpg","Valentina","4 review - 9 photos",3,"Lo recomiendo bastante."),
        Review("assets/images/persona4.jpg","Chuck Norris","7 review - 9 photos",3,"Me gustria conocerlo."),
        Review("assets/images/persona5.jpg","Richard Wagner","2 review - 3 photos",3,"Hermoso lugar para visitar."),
      ],
    );
